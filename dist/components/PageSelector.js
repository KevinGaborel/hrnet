...
var PageSelector = function PageSelector(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_BtnPage.default, {
    value: 'Prev',
    ...
    return /*#__PURE__*/React.createElement(_BtnPage.default, {
  ...
  }), /*#__PURE__*/React.createElement(_BtnPage.default, {
    value: 'Next',
